...
class make_ensamble(model_primitive): 
    def __init__(self, model_list,base_model_params=[], ensamble_type='Stacking',model_id="", meta_learner=None, meta_learner_params=None, hyper_parameters=None, challenge="Regression"):
        ## exception cehcking. 
